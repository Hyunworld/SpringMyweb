...
public class ReplyController {
	...
	@PostMapping(value = "/replyRegist", produces = "application/json")//컨패스
...
//		map.put("list", list);
		...
		//2nd-더보기 처리
		//1. 화면에 더보기 버튼생성
		//2.getList(글번호, critera)를 매개변수로 받습니다.
		//3.mybatis인터페이스에 글번호와 critera에 @Param("이름")
		//4.sql변경
		//5. 전체 댓글 수를 화면에 전달.
	...
	public int delete(@RequestBody FreeReplyVO vo  ) {
		...
		int count = replyService.delete(vo);
